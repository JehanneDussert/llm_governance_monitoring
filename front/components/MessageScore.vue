<template>
  <div class="message-score" :class="state">
    <template v-if="state === 'evaluating'">
      ...
      <span class="eval-label">evaluating...</span>
    </template>
...
import type { EvalResult } from '@/api/client.ts'
import { useJudgeStore } from '@/stores/judge.ts'
